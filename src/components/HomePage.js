            ...
            <Paper className={classes.paperTwo} elevation={3}>
              ...
              >
                ...
                >
                  <PlanetPanel
                    planet="Sun"
                    sign={planetsQuery[0].rasi ? planetsQuery[0].rasi.name : ""}
                    currenttab={value}
                ...
                >
                  <PlanetPanel
                    planet="Moon"
                    sign={planetsQuery[1].rasi ? planetsQuery[1].rasi.name : ""}
                    currenttab={value}
                    onChange={handleChangeArrow}
                    planetsQuery={planetsQuery}
                    isLoading={props.isLoading}
                ...
                >
                  <PlanetPanel
                    planet="Mercury"
                    sign={planetsQuery[2].rasi ? planetsQuery[2].rasi.name : ""}
                    currenttab={value}
                    onChange={handleChangeArrow}
                    planetsQuery={planetsQuery}
                    isLoading={props.isLoading}
                ...
                >
                  <PlanetPanel
                    planet="Venus"
                    sign={planetsQuery[3].rasi ? planetsQuery[3].rasi.name : ""}
                    currenttab={value}
                    onChange={handleChangeArrow}
                    planetsQuery={planetsQuery}
                    isLoading={props.isLoading}
                ...
                >
                  <PlanetPanel
                    planet="Mars"
                    sign={planetsQuery[4].rasi ? planetsQuery[4].rasi.name : ""}
                    currenttab={value}
                    onChange={handleChangeArrow}
                    planetsQuery={planetsQuery}
                    isLoading={props.isLoading}
                ...
                >
                  <PlanetPanel
                    planet="Jupiter"
                    sign={planetsQuery[5].rasi ? planetsQuery[5].rasi.name : ""}
                    currenttab={value}
                    onChange={handleChangeArrow}
                    planetsQuery={planetsQuery}
                    isLoading={props.isLoading}
                ...
                >
                  <PlanetPanel
                    planet="Saturn"
                    sign={planetsQuery[6].rasi ? planetsQuery[6].rasi.name : ""}
                    currenttab={value}
                    onChange={handleChangeArrow}
                    planetsQuery={planetsQuery}
                    isLoading={props.isLoading}
