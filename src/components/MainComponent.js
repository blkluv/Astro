...
function MainComponent() {
  ...
  async function getAccessToken() {
    ...
    let request = new Request(
      "https://alkemystcorsproxy.herokuapp.com/https://api.prokerala.com/token",
      {
        headers: new Headers({
          "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
        }),
        method: "POST",
        body: querystring.stringify(bodyParameters),
      }
    );
        ...
        .then((data) => {
          if (data.data != undefined) {
            ...
            setPlanets([
              ...
              data.data.planet_position[2],
              data.data.planet_position[3],
              data.data.planet_position[4],
              data.data.planet_position[5],
